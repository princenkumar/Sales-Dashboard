...
1. **Download** `Sales-Dashboard-2024.xlsx`
2. **Open** in Microsoft Excel
3. **Enable editing** to access interactive features
4. **Use filters** and **slicers** for custom analysis
5. **Refresh data** if needed (F9 key)

### For Quick Viewing:
- Open `Sales-Dashboard-With-Pivot.pdf` for static report
- Check `screenshots/` folder for visual previews

## 🤝 Contributing
This is a sample sales dashboard for educational and demonstration purposes.

## 📄 License
This project is for educational use only.

## 📞 Support
For questions regarding this dashboard, please open an issue in this repository.

---

*Data Period: January 2013 - August 2013*  
